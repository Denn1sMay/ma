...
def replace_trial_function(sympy_function, trial_function: sympy.Function, trial_function_name: str):
...
def replace_test_function(sympy_function, test_function: sympy.Function, test_function_name: str):
...
def convert_integral_to_ufl_string(integral: sympy.Integral, trial_function: sympy.Function, test_function: sympy.Function, trial_function_name: str, test_function_name: str):
...
def convert(sympy_equation: sympy.Eq, symbolic_trial_function: sympy.Function, symbolic_test_function: sympy.Function, trial_function_name: str, test_function_name: str):
